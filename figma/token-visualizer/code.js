...
(() => {
    ...
    return Object.entries(values).map(([modeId, value]) => {
      return "values" in value
        ? /* @__PURE__ */ figma.widget.h(
            ...
            /* @__PURE__ */ figma.widget.h(
              AutoLayout,
              { width: "fill-parent", spacing: "auto" },
              /* @__PURE__ */ figma.widget.h(
                Text,
  ...
  async function render(collections2) {
    const node = /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      { name: "Variables", spacing: 100 },
      Object.entries(collections2).map(([id, { name, modes, variables }]) => {
        return /* @__PURE__ */ figma.widget.h(
          ...
          /* @__PURE__ */ figma.widget.h(
            ...
            modes.map(({ name: name2 }) =>
              /* @__PURE__ */ figma.widget.h(
                AutoLayout,
                { width: DIMENSION_COL_WIDTH, key: name2 },
                /* @__PURE__ */ figma.widget.h(
                  Text,
                  { fontSize: FONT_SIZE_H2 },
                  modes.length > 1 ? name2 : "Value"
                )
              )
            )
          ),
          variables
            ...
            .map(({ id: id2, description, name: name2, values }) => {
              return /* @__PURE__ */ figma.widget.h(
                AutoLayout,
                {
                  key: name2,
  ...
  function valueToJSON(value) {
    if (
      ...
      const map = {};
      const values = Object.keys(variable.valuesByMode).reduce(
        (into, modeId) => {
